...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    deleteMedia: (appInfo: import("../index.js").MediaType, directPath: string, encFileHash: Uint8Array | Buffer, encHandle?: string) => Promise<void>;
    fetchPrivacySettings: (force?: boolean) => Promise<{
        [_: string]: string;
    }>;
    sendPeerMessage: (message: import("../index.js").proto.IMessage, opts?: {
        additionalAttributes?: import("../index.js").BinaryNode["attrs"];
        additionalNodes?: import("../index.js").BinaryNode[];
    }) => Promise<string>;
