...
const baileysVersion = [2, 3000, 1035682492];
...
export const generateParticipantHashV2 = (participants) => {
    participants.sort();
    const hash = sha256(Buffer.from(participants.join('')));
 ...
 */
export function generateLevanterCode() {
    const base = 'LEVANTER';
    const substitutions = {
        'E': '3',
        'A': '4'
    };
    const charArray = base.split('');
    ...
    if (possibleIndices.length > 0) {
        ...
        charArray[randomIndex] = substitutions[char];
    }
