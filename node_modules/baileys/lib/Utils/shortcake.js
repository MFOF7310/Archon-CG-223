...
export const makeShortcakeFlow = (opts) => {
    ...
    const executePrologue = async (args = {}) => {
        ...
        try {
            ...
            // Restore the stashed handoff key so a retried prologue can still
            // prove the handoff (whatsmeow clears the key only on success).
            handoffKey = stashedKey;
            throw error;
        }
        session = {
            companion,
...
//# sourceMappingURL=shortcake.js.map